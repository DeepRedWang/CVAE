...
from Model.CVmodel2 import SAE521
...
def train():
    ...
    paramfilename = f'SAE521 outRD 500000 fixedD32_256 bs{batch_size} {epoch_num}epoch'
    test_name1 = 'Yak42'
    Train_flag = False
    ################
    ...
    """model"""
    model = SAE521(in_features=32, out_features=256)
    ...
    # print(flag)
    test_model = SAE521(in_features=32, out_features=256)
    test_model.to(test_device)
    test_model.eval()
    test_model.load_state_dict(torch.load(f"{path}/bs512_lr001_eph1000_99_minvalidloss.pth"))
