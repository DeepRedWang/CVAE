...
from Model.CVmodel2 import SAE431
...
def train():
    ...
    paramfilename = f'SAE431 outRD 500000 fixedD32_256 bs{batch_size} {epoch_num}epoch'
    test_name1 = 'Yak42'
    Train_flag = True
    ################
    ...
    """model"""
    model = SAE431(in_features=32, out_features=256)
    ...
    print(flag)
    test_model = SAE431(in_features=32, out_features=256)
